...
interface GetStyleForParagraphProps {
    (props: HtmlParagraphStylePropsWithTheme): string;
}
declare const getStyleForParagraphProps: GetStyleForParagraphProps;

interface HandleFontFromThemeParametersForWeb {

...
interface HandleFontFromThemeParameters<T> {
    (fontType: keyof ThemeInterface['fonts'], fontTypeWeight: keyof FontTypeWeight, theme: T): string;
}

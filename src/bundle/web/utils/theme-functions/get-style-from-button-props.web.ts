import { ButtonStyleGenerator, WebTheme } from "../../../shared/types/base-theme-types";
import { ButtonStyleFromProps } from "../../../shared/types/button-style-props.types";




export const getStyleFromButtonPropsForWeb: ButtonStyleGenerator<WebTheme, string | number>  = ({
  borderBottomWidth,
  maxWidth,
  borderRadius,
  paddingBottom,
  ...
  paddingTop,
  alignSelf,
}: ButtonStyleFromProps<WebTheme,string | number>): string => {
  const css: string[] = [];
...
export default getStyleFromButtonPropsForWeb;

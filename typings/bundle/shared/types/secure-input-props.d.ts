...
export interface SecureInputProps<ContainerStyleProps = {}, OnChangeText = (text: string) => void, OnSubmitEditing = (e: any) => void, KeyboardType = KeyBoardTypeEnum, AutoCapitalize = AutoCapitalizeEnum> extends BaseTextInputProps<ContainerStyleProps, OnChangeText, OnSubmitEditing, KeyboardType, AutoCapitalize> {

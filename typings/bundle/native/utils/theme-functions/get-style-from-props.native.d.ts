...
export declare const getStyleFromPropsNative: ({ maxWidth, maxHeight, height, theme, marginTop, width, backgroundColorFromTheme, marginBottom, minHeight, opacity, marginLeft, marginRight, paddingLeft, borderColorFromTheme, paddingRight, margin, borderWidth, flex, paddingTop }: ComprehensiveStyleProps<NativeTheme, number>) => string;

...
import { handleFontFromTheme } from "./get-style/handle-font-for-theme";
...
export interface handleColorFromThemeInterface {
  (color: keyof colorsInterface, opacity: number, theme: ThemeInterface): string | elevationObjType;
}
